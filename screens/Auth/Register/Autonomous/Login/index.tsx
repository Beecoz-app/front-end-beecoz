...
type ClientRegisterLoginType = NativeStackScreenProps<AuthStackParams, 'registerAutonomousLogin'>

export const AutonomousRegisterLoginScreen = ({navigation: {navigate}}: ClientRegisterLoginType) => {
  ...
  return (
    <Container>
      ...
      <ButtonContainer>
        <AppGenericButton disabled={disabled} title={"Continuar"} onClick={() => navigate('registerAutonomousPassword')}/>
      </ButtonContainer>
    </Container>
  );
};