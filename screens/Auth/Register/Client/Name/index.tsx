...
type ClientRegisterNameScreenType = NativeStackScreenProps<AuthStackParams, 'registerClientName'>

export const ClientRegisterNameScreen = ({navigation: {navigate}}: ClientRegisterNameScreenType) => {
